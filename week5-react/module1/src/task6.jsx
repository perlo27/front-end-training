    ...
    return <Switch>
            ...
            (pathProps) =>
              <div key="Route-path-/">
                ...
                <div key="div-search-row" className="searchRow">
                  ...
                  <input key="Task6-searchRow-input-search"
                    type="button"
                    value="SEARCH"
                    ...
                    { this.state.searchMovieList.length  ?
                      <div key="Task6-div-search-movie-list">
                        <div key="Task6-div-search-movie-list-sort">
                          <span>
                            {this.state.searchMovieList.length} Movies Found
                          </span>
                          <div>
                            <span>Sort By</span>
                            <input
        ...
        <Route
          ...
          render = {  (props) => {
            ...
            const selectedMovie =
              this.allMovies.find(movie => movie.id === movieId);
            const similarMovies =
              this.allMovies.filter(otherMovie =>
                otherMovie.genre === selectedMovie.genre
                &&
                otherMovie.id !== movieId);

            return (
              <SelectedMovie key={"Task6-SelectedMovie"}
                movie={selectedMovie}
